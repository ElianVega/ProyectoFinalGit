 ...
 * el campo Documento del texto está vacío. 
 * La propiedad Show se usa para determinar la visibilidad del mensaje.
 *
 * La fuente y el color de primer plano del mensaje se establecerán de forma predeterminada en esas propiedades
 * del componente de texto principal. Eres libre de cambiar las propiedades después
